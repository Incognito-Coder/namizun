...
```bash
sudo curl https://raw.githubusercontent.com/Incognito-Coder/namizun/master/else/setup.sh | sudo bash
```
...
```bash
git remote add origin https://github.com/Incognito-Coder/namizun.git
```
